...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .judul-section .periode-badge { display: inline-block; margin-top: 6px; font-size: 10pt; font-weight: bold; }
        ...
        /* REKAPITULASI */
        .rekap-title { font-size: 11pt; font-weight: bold; margin-bottom: 6px; text-decoration: underline; }
        .rekap-grid {
            display: grid;
        ...
        .rekap-box { border: 1px solid #555; padding: 8px 10px; text-align: center; }
        ...
        /* TABEL */
        .tabel-title { font-size: 11pt; font-weight: bold; margin-bottom: 6px; text-decoration: underline; }
        table.laporan { width: 100%; border-collapse: collapse; font-size: 10pt; margin-bottom: 20px; }
        table.laporan thead tr { background: #ddd; }
        table.laporan th { border: 1px solid #333; padding: 6px 8px; text-align: center; font-weight: bold; font-size: 9.5pt; }
        table.laporan td { border: 1px solid #555; padding: 5px 8px; vertical-align: top; }
        table.laporan td.center { text-align: center; }
        table.laporan td.bold { font-weight: bold; }

        .pemohon-item { padding: 2px 0; border-bottom: 1px dotted #bbb; font-size: 9.5pt; }
        .pemohon-item:last-child { border-bottom: none; }
        .pemohon-status { font-size: 8.5pt; color: #333; }
...
<body>
    ...
    <div class="info-grid">
        ...
        <span>Dicetak oleh</span><span>:</span><span>Kepala Desa — Sistem Surat Desa Karombo</span>
    </div>
    ...
    <table class="laporan">
        <thead>
            <tr>
                ...
                <th style="width:64px">Menunggu TTD</th>
    ...
    <div class="ttd-section">
        <div class="ttd-box">
            ...
            <div class="ttd-jabatan">Kepala Desa Karombo</div>
